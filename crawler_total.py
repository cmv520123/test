...
def crawler_all(keyword):
    ...
    drop_data.to_excel(raw_folder + '/' +keyword+'_ok_'+ web +'_網路爬蟲.xlsx',index=False)

    df = pd.read_excel(raw_folder + '/' +keyword+ '_ok_' + web + '_網路爬蟲.xlsx') #請自行依檔案位置調整
    print(keyword+'_'+web+ '_總共有'+str(len(df))+'篇文章')
    ...
    wb.save(raw_folder + '/' +keyword + '_yet_'+ web + '_網路爬蟲.xlsx')

    import pandas as pd
    df = pd.read_excel(raw_folder + '/' +keyword + '_yet_'+ web + '_網路爬蟲.xlsx') #請自行依檔案位置調整
    # print(keyword+'_'+web+ '_總共有'+str(len(df))+'篇文章')
    ...
    all_article = txt_folder + keyword + '_'  + web +'_網路爬蟲.txt'
    filename1 = raw_folder + '/' + keyword+'_媽咪拜_網路爬蟲.xlsx'
    title =["文章標題","文章內容"]
    ...
    filename2 = raw_folder + '/' + keyword+'_媽咪愛_網路爬蟲.xlsx'
    ...
    filename3 = raw_folder + '/' + keyword+'_ok_Dcard深卡_網路爬蟲.xlsx'
    title = ['文章標題','文章內容']
    ...
    filename4 = raw_folder + '/' + keyword+'_PTT_網路爬蟲.xlsx'
    ...
    filename5 = raw_folder + '/' + keyword+'_TVBS_網路爬蟲.xlsx'
    title =["文章標題","文章內容"]
    ...
    filename6 = raw_folder + '/' + keyword + '_ok_華人健康網_網路爬蟲.xlsx'
    title =["文章標題",'文章內容']
